...
public interface IDialogService
{
    ...
    /// <summary>
    /// Asynchronously displays a choice dialog with a title, a message, primary and secondary action buttons, and a close button.
    /// </summary>
    /// <param name="title">The title of the dialog.</param>
    /// <param name="message">The message describing the choices available.</param>
    /// <param name="primaryButtonText">The text for the primary action button.</param>
    /// <param name="secondaryButtonText">The text for the secondary action button.</param>
    /// <param name="closeButtonText">The text for the close or cancel button.</param>
    /// <returns>A <see cref="ContentDialogResult"/> representing the user's choice.</returns>
    Task<ContentDialogResult> ShowChoiceDialogAsync(string title, string message, string primaryButtonText,
...
public class DialogService : IDialogService
{
    ...
    /// <inheritdoc/>
    public async Task<ContentDialogResult> ShowChoiceDialogAsync(string title, string message, string primaryButtonText,
